...
- [ICSoccerWorld Trainer](https://github.com/ktimam/SoccerTrainer) - Flashlight Multilayer Perceptron Deep Learning used for training Soccer Agents on ICP blockchain.
