...
- [icrc-ledger-types](https://crates.io/crates/icrc-ledger-types) – This package defines types for interacting with the DFINITY implementation of the ICRC-1 fungible token standard.
- [icrc-ledger-agent](https://crates.io/crates/icrc-ledger-agent) – This package provides functions for interacting with the DFINITY implementation of the ICRC-1 fungible token standard.
- [icrc-ledger-client](https://crates.io/crates/icrc-ledger-client) – This package defines functions for interacting with the DFINITY implementation of the ICRC-1 fungible token standard ledger from canister code.
